...
@implementation WentViewController
...
- (IBAction)goFollow:(id)sender {
    ...
    if(tableClick == 0){
        ...
        [UIView animateWithDuration:0.3 animations:^{
            [followTable setFrame:CGRectMake(0, 148, 159, 408)];
